...
const RentTable = () => {
  ...
  const products = {
    ...
    "Study Table + Chair": [
      ...
      { img: "/images/mattress2.jpg", type: "Spring Mattress", price: "₹399/mo" },
      { img: "/images/mattress3.jpg", type: "Orthopedic Mattress", price: "₹499/mo" },
    ],
  };
    ...
    <div className="m-2">
      ...
      >
        <Container>
          ...
          >
            Tables and Chairs on Rent
          </h1>

          <Row className="g-4 px-2" style={{ marginTop: "77px" }}>
            {[
              { image: "/studytable+chair.png", title: <>Dressing Table</> },
              { image: "/studytable.png", title: <>Chairs</> },
              { image: "/chair.png", title: <>Study Table</> },
              { image: "/dressingtable.png", title: <>Study Table + <br />Chair</> },
            ].map((item, idx) => (
          ...
          {renderProductGrid("Dressing Table")}
          {renderProductGrid("Chairs")}
          {renderProductGrid("Study Table")}
          {renderProductGrid("Study Table + Chair")}
        </Container>
      </div>
