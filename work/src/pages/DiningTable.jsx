        ...
        {products[category].map((product, index) => (
          <Col key={index} xs={12} sm={6} md={4}>
            ...
            >
              ...
              <p className="fw-semibold mt-2  text-center">Type 2</p>
    ...
    <div className="m-2">
      ...
      >
        <Container>
          ...
          >
           Dining Tables on Rent
          </h1>

          <Row className="g-4 px-2" style={{ marginTop: "77px" }}>
            {[
              { image: "/diningtable.png", title: <>Center Tables</> },
              { image: "/centertable.png", title: <>Dining Tables</> },
          ...
          {renderProductGrid("Center Tables")}
          {renderProductGrid("Dining Tables")}
