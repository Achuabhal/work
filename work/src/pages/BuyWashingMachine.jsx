...
const BuyWashingMachine = () => {
  ...
  { title: "Full Automatic (Top Loaded)" },
  ...
  <Col key={idx} xs={6} sm={4} md={3} className="text-center">
    ...
    <p className="fw-semibold mt-2">{item.title}</p>
          ...
          {renderProductGrid("Semi Automatic")}
          {renderProductGrid("Full Automatic (Top Loaded)")}
...
export default BuyWashingMachine;
