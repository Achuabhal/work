...
const ChefForParty = () => {
  ...
  const [showMainContent, setShowMainContent] = useState(false); // New state to control main content visibility
  ...
  const handleOptionSelect = (option) => {
    ...
    // If Chef for Party is selected, show the terms modal
  ...
  return (
    <div className="me-2 ms-2 ps-2 pe-2 w-98">
      ...
      {/* Main Content - Only show when showMainContent is true or when selectedOption is set and terms are accepted */}
      {(showMainContent || (selectedOption === "Chef for Party" && !showModal)) && (
        <>
          {/* Navbar */}
          <Navbar
