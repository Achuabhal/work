      ...
      <div className="flex-grow-1">
        <Container fluid className="d-flex flex-column p-0 m-0">
          <Row className="gx-0 d-flex flex-column flex-md-row flex-grow-1 main-wrapper h-100 p-0 m-0">
            ...
            >
              {/* Centered Mixer Repair Heading */}
              <div className="text-center mb-4">
                <h2 className="fw-bold display-5">Mixer Repair</h2>
              </div>
              ...
              <div className="mb-4">
                ...
                >
                  {mixerServices.map((service, index, arr) => (
                    <div
                      key={index}
                      className={`p-3 ${
                        index !== arr.length - 1
