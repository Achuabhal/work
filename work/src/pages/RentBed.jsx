      ...
      >
        <Container>
          ...
          <Row className="g-4 px-2" style={{ marginTop: "77px" }}>
            {[
              { image: "/singlebed.png", title: <>Single Bed</> },
              { image: "/doublebed.png", title: <>Double Bed</> },
              { image: "/queenbed.png", title: <>Queen Size Bed</> },
              { image: "/mattrices.png", title: <>Comfortable Mattress</> },
            ].map((item, idx) => (
