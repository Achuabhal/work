...
const BuyRefrigerator = () => {
  ...
  <Col key={idx} xs={6} sm={4} md={3} className="text-center">
    ...
    <p className="fw-semibold mt-2">{item.title}</p>
          ...
          {renderProductGrid("170 Litres")}
          {renderProductGrid("190 Litres")}
          {renderProductGrid("230 Litres (Double Door)")}
...
export default BuyRefrigerator;
